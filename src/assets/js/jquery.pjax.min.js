!(function (t) {
    ...
    function n(e, n, a) {
        ...
        if (
            !(
                ...
                e.shiftKey ||
                e.altKey ||
                location.protocol !== i.protocol ||
                location.hostname !== i.hostname ||
                (i.href.indexOf('#') > -1 && h(i) == h(location)) ||
                e.isDefaultPrevented()
            )
        ) {
            var c = { url: i.href, container: o.attr('data-pjax'), target: i },
                s = t.extend({}, c, a),
    ...
    function a(e, n, a) {
        ...
        if ('GET' !== c.type && void 0 !== window.FormData)
            (c.data = new FormData(i)), (c.processData = !1), (c.contentType = !1);
        else {
    ...
    function r(e) {
        ...
        e.data || (e.data = {}),
            t.isArray(e.data) ? e.data.push({ name: '_pjax', value: e.container }) : (e.data._pjax = e.container);
        var s;
        (e.beforeSend = function (t, r) {
            if (
                ('GET' !== r.type && (r.timeout = 0),
            ...
            (e.success = function (i, s, u) {
                ...
                m.title && (document.title = m.title),
                    n('pjax:beforeReplace', [m.contents, e], { state: r.state, previousState: p }),
                    c.html(m.contents);
        ...
        return (
            h.readyState > 0 &&
                (e.push &&
                    !e.replace &&
                    (j(r.state.id, [e.container, p(c)]), window.history.pushState(null, '', e.requestUrl)),
                n('pjax:start', [h, e]),
                n('pjax:send', [h, e])),
            r.xhr
        );
    ...
    function s(e) {
        ...
        'GET' !== a &&
            'POST' !== a &&
            r.append(t('<input>', { type: 'hidden', name: '_method', value: a.toLowerCase() }));
        var i = e.data;
        if ('string' == typeof i)
    ...
    function d(t) {
        return (
            (t.search = t.search.replace(/([?&])(_pjax|_)=[^&]*/g, '').replace(/^&/, '')),
            t.href.replace(/\?($|#)/, '$1')
        );
    }
    function f(t) {
    ...
    function g(e, n, a) {
        ...
        if (((r.title = v(c, 'title').last().text()), a.fragment)) {
            ...
            'body' !== a.fragment && (l = v(l, a.fragment).first()),
                l.length &&
                    ((r.contents = 'body' === a.fragment ? l : l.contents()),
